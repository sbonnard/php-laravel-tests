...
<body>
    ...
    <main class="container">
        ...
        <form class="form" action="<?php echo e(@route('film.update')); ?>" method="post">
...
</html><?php /**PATH C:\wamp64\www\php-laravel-tests\resources\views/film/edit.blade.php ENDPATH**/ ?>